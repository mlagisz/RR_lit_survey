...
```{r load data}
data0 <- read.csv(file = "./data/AMSTAR2_sheet_RRs_v1_simplified.csv", colClasses = "character")
dim(data0)
str(data0)
...
## save plot
ggsave(file = "figure_RR_apprisal2_v01.pdf", width = 16.5, height = 12, units = "cm", scale = 1.5, device = cairo_pdf)
```
